 ...
 * <p>
 * <b>Note:</b> On Windows, SVG output is not natively supported by the operating system.
 * This class is provided for API compatibility with other platforms. On Windows,
 * using this class will result in an {@link SWTException} with error code
 * {@link SWT#ERROR_NOT_IMPLEMENTED}.
 * </p>
 * <p>
 * For SVG support on Windows, consider using third-party libraries or converting
...
public class SVGDocument implements Drawable {
	 ...
	 * <p>
	 * <b>Note:</b> SVG output is not supported on Windows. This constructor
	 ...
	 *    <li>ERROR_NOT_IMPLEMENTED - SVG output is not supported on Windows</li>
	 * </ul>
	 *
	 * @see #dispose()
	 */
	 ...
	 * <p>
	 * Note: Since SVG output is not supported on Windows, this always returns false
