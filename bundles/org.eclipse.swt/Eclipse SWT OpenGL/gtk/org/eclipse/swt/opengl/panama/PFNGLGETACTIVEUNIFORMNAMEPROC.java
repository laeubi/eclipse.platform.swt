...
public interface PFNGLGETACTIVEUNIFORMNAMEPROC {
    ...
    static NativeSymbol allocate(PFNGLGETACTIVEUNIFORMNAMEPROC fi, ResourceScope scope) {
    ...
    static PFNGLGETACTIVEUNIFORMNAMEPROC ofAddress(MemoryAddress addr, ResourceScope scope) {
        NativeSymbol symbol = NativeSymbol.ofAddress("PFNGLGETACTIVEUNIFORMNAMEPROC::" + Long.toHexString(addr.toRawLongValue()), addr, scope);
return (int x0, int x1, int x2, jdk.incubator.foreign.MemoryAddress x3, jdk.incubator.foreign.MemoryAddress x4) -> {
            try {
                constants$176.PFNGLGETACTIVEUNIFORMNAMEPROC$MH.invokeExact(symbol, x0, x1, x2, (jdk.incubator.foreign.Addressable)x3, (jdk.incubator.foreign.Addressable)x4);
            } catch (Throwable ex$) {
