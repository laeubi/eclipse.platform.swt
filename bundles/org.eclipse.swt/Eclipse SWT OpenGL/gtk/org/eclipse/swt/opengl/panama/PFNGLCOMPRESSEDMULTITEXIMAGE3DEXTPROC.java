...
public interface PFNGLCOMPRESSEDMULTITEXIMAGE3DEXTPROC {
    ...
    static NativeSymbol allocate(PFNGLCOMPRESSEDMULTITEXIMAGE3DEXTPROC fi, ResourceScope scope) {
    ...
    static PFNGLCOMPRESSEDMULTITEXIMAGE3DEXTPROC ofAddress(MemoryAddress addr, ResourceScope scope) {
        NativeSymbol symbol = NativeSymbol.ofAddress("PFNGLCOMPRESSEDMULTITEXIMAGE3DEXTPROC::" + Long.toHexString(addr.toRawLongValue()), addr, scope);
return (int x0, int x1, int x2, int x3, int x4, int x5, int x6, int x7, int x8, jdk.incubator.foreign.MemoryAddress x9) -> {
            try {
                constants$567.PFNGLCOMPRESSEDMULTITEXIMAGE3DEXTPROC$MH.invokeExact(symbol, x0, x1, x2, x3, x4, x5, x6, x7, x8, (jdk.incubator.foreign.Addressable)x9);
            } catch (Throwable ex$) {
