...
public class pthread_rwlockattr_t {
    ...
    static final  GroupLayout $union$LAYOUT = MemoryLayout.unionLayout(
        MemoryLayout.sequenceLayout(8, Constants$root.C_CHAR$LAYOUT).withName("__size"),
        Constants$root.C_LONG_LONG$LAYOUT.withName("__align")
    );
    public static MemoryLayout $LAYOUT() {
        return pthread_rwlockattr_t.$union$LAYOUT;
    }
    ...
    public static VarHandle __align$VH() {
        return pthread_rwlockattr_t.__align$VH;
    }
    public static long __align$get(MemorySegment seg) {
        return (long)pthread_rwlockattr_t.__align$VH.get(seg);
    }
    public static void __align$set( MemorySegment seg, long x) {
        pthread_rwlockattr_t.__align$VH.set(seg, x);
    }
    public static long __align$get(MemorySegment seg, long index) {
        return (long)pthread_rwlockattr_t.__align$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void __align$set(MemorySegment seg, long index, long x) {
        pthread_rwlockattr_t.__align$VH.set(seg.asSlice(index*sizeof()), x);
    }
