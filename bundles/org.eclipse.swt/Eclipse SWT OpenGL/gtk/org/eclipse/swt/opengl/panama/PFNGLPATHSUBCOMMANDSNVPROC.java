...
public interface PFNGLPATHSUBCOMMANDSNVPROC {
    ...
    static NativeSymbol allocate(PFNGLPATHSUBCOMMANDSNVPROC fi, ResourceScope scope) {
    ...
    static PFNGLPATHSUBCOMMANDSNVPROC ofAddress(MemoryAddress addr, ResourceScope scope) {
        NativeSymbol symbol = NativeSymbol.ofAddress("PFNGLPATHSUBCOMMANDSNVPROC::" + Long.toHexString(addr.toRawLongValue()), addr, scope);
return (int x0, int x1, int x2, int x3, jdk.incubator.foreign.MemoryAddress x4, int x5, int x6, jdk.incubator.foreign.MemoryAddress x7) -> {
            try {
                constants$781.PFNGLPATHSUBCOMMANDSNVPROC$MH.invokeExact(symbol, x0, x1, x2, x3, (jdk.incubator.foreign.Addressable)x4, x5, x6, (jdk.incubator.foreign.Addressable)x7);
            } catch (Throwable ex$) {
