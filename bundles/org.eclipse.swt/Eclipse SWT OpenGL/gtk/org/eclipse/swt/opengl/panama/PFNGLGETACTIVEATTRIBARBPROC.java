...
public interface PFNGLGETACTIVEATTRIBARBPROC {
    ...
    static NativeSymbol allocate(PFNGLGETACTIVEATTRIBARBPROC fi, ResourceScope scope) {
    ...
    static PFNGLGETACTIVEATTRIBARBPROC ofAddress(MemoryAddress addr, ResourceScope scope) {
        NativeSymbol symbol = NativeSymbol.ofAddress("PFNGLGETACTIVEATTRIBARBPROC::" + Long.toHexString(addr.toRawLongValue()), addr, scope);
return (int x0, int x1, int x2, jdk.incubator.foreign.MemoryAddress x3, jdk.incubator.foreign.MemoryAddress x4, jdk.incubator.foreign.MemoryAddress x5, jdk.incubator.foreign.MemoryAddress x6) -> {
            try {
                constants$400.PFNGLGETACTIVEATTRIBARBPROC$MH.invokeExact(symbol, x0, x1, x2, (jdk.incubator.foreign.Addressable)x3, (jdk.incubator.foreign.Addressable)x4, (jdk.incubator.foreign.Addressable)x5, (jdk.incubator.foreign.Addressable)x6);
            } catch (Throwable ex$) {
