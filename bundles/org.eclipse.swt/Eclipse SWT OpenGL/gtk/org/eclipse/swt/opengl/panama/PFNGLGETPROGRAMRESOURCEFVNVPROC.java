...
public interface PFNGLGETPROGRAMRESOURCEFVNVPROC {
    ...
    static NativeSymbol allocate(PFNGLGETPROGRAMRESOURCEFVNVPROC fi, ResourceScope scope) {
    ...
    static PFNGLGETPROGRAMRESOURCEFVNVPROC ofAddress(MemoryAddress addr, ResourceScope scope) {
        NativeSymbol symbol = NativeSymbol.ofAddress("PFNGLGETPROGRAMRESOURCEFVNVPROC::" + Long.toHexString(addr.toRawLongValue()), addr, scope);
return (int x0, int x1, int x2, int x3, jdk.incubator.foreign.MemoryAddress x4, int x5, jdk.incubator.foreign.MemoryAddress x6, jdk.incubator.foreign.MemoryAddress x7) -> {
            try {
                constants$798.PFNGLGETPROGRAMRESOURCEFVNVPROC$MH.invokeExact(symbol, x0, x1, x2, x3, (jdk.incubator.foreign.Addressable)x4, x5, (jdk.incubator.foreign.Addressable)x6, (jdk.incubator.foreign.Addressable)x7);
            } catch (Throwable ex$) {
