...
public interface PFNGLCOMPRESSEDTEXTURESUBIMAGE3DEXTPROC {
    ...
    static NativeSymbol allocate(PFNGLCOMPRESSEDTEXTURESUBIMAGE3DEXTPROC fi, ResourceScope scope) {
    ...
    static PFNGLCOMPRESSEDTEXTURESUBIMAGE3DEXTPROC ofAddress(MemoryAddress addr, ResourceScope scope) {
        NativeSymbol symbol = NativeSymbol.ofAddress("PFNGLCOMPRESSEDTEXTURESUBIMAGE3DEXTPROC::" + Long.toHexString(addr.toRawLongValue()), addr, scope);
return (int x0, int x1, int x2, int x3, int x4, int x5, int x6, int x7, int x8, int x9, int x10, jdk.incubator.foreign.MemoryAddress x11) -> {
            try {
                constants$566.PFNGLCOMPRESSEDTEXTURESUBIMAGE3DEXTPROC$MH.invokeExact(symbol, x0, x1, x2, x3, x4, x5, x6, x7, x8, x9, x10, (jdk.incubator.foreign.Addressable)x11);
            } catch (Throwable ex$) {
