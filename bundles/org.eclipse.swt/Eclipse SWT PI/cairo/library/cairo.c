...
#ifndef NO_cairo_1svg_1surface_1create
JNIEXPORT jlong JNICALL Cairo_NATIVE(cairo_1svg_1surface_1create)
	(JNIEnv *env, jclass that, jbyteArray arg0, jdouble arg1, jdouble arg2)
{
	jbyte *lparg0=NULL;
	jlong rc = 0;
	Cairo_NATIVE_ENTER(env, that, cairo_1svg_1surface_1create_FUNC);
	if (arg0) if ((lparg0 = (*env)->GetByteArrayElements(env, arg0, NULL)) == NULL) goto fail;
/*
	rc = (jlong)cairo_svg_surface_create((const char *)lparg0, arg1, arg2);
*/
	{
		Cairo_LOAD_FUNCTION(fp, cairo_svg_surface_create)
		if (fp) {
			rc = (jlong)((cairo_surface_t * (CALLING_CONVENTION*)(const char *, jdouble, jdouble))fp)((const char *)lparg0, arg1, arg2);
		}
	}
fail:
	if (arg0 && lparg0) (*env)->ReleaseByteArrayElements(env, arg0, lparg0, 0);
	Cairo_NATIVE_EXIT(env, that, cairo_1svg_1surface_1create_FUNC);
	return rc;
}
#endif

#ifndef NO_cairo_1svg_1surface_1restrict_1to_1version
JNIEXPORT void JNICALL Cairo_NATIVE(cairo_1svg_1surface_1restrict_1to_1version)
	(JNIEnv *env, jclass that, jlong arg0, jint arg1)
{
	Cairo_NATIVE_ENTER(env, that, cairo_1svg_1surface_1restrict_1to_1version_FUNC);
/*
	cairo_svg_surface_restrict_to_version((cairo_surface_t *)arg0, arg1);
*/
	{
		Cairo_LOAD_FUNCTION(fp, cairo_svg_surface_restrict_to_version)
		if (fp) {
			((void (CALLING_CONVENTION*)(cairo_surface_t *, jint))fp)((cairo_surface_t *)arg0, arg1);
		}
	}
	Cairo_NATIVE_EXIT(env, that, cairo_1svg_1surface_1restrict_1to_1version_FUNC);
}
#endif
